  ...
  return (
    <div className="card">
      <div className="card-h">
        <div>
          <h2>우리 쪽 발화자</h2>
          <div className="desc">여기 있는 이름으로 들어온 메시지는 우리가 보낸 것으로 표시됩니다.</div>
        </div>
      </div>
      <div className="frow">
        <div>
          <div className="fl">직원 카톡 닉네임</div>
          <div className="fd">
            카톡에서 쓰는 실제 닉네임을 그대로 넣으세요. 세 글자 이상은 일부만 같아도 인식하고,
            두 글자 이름은 완전히 같을 때만 인식합니다. 저장하면 이미 쌓인 대화의 표시도 함께 다시
            맞춥니다.
          </div>
        </div>
        <div>

    ...
    <>
      ...
      <div className="card">
        ...
        <div className="fhint" style={{ fontSize: 12.5, lineHeight: 1.8 }}>
          봇은 이 폰에 오는 카톡을 서버로 올리고, <b>거래처에 연결된 방만 저장</b>합니다.
          연결 안 된 방(개인 카톡·가족방 등)은 <b>본문을 저장하지 않습니다</b> — 아래 “연결 안 된 방”
          목록에 방 하나와 수신 횟수만 남고 대화 내용은 버려집니다. 사진은 아예 올리지도 않습니다.
          <br />
          <br />
          그래서 개인 카톡방 이름이 “연결 안 된 방” 목록에 뜰 수 있습니다. 정상입니다 — 거기 뜬 방을
          연결하지만 않으면 대화는 남지 않습니다. 목록에서 <b>내리기</b>로 지울 수 있습니다.
        </div>
      </div>
    </>
  );
